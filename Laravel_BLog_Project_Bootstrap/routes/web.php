...
Route::get('/like_article/{article_id}',[LikesController::class,'update_like'])->middleware('auth');
...
Route::get('/editArticle/{article_id}',[ArticleController::class,'show_editForm']);
Route::post('/editArticle/{article_id}',[ArticleController::class,'edit_article']);
